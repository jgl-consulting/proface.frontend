...
export const actions = {
  async fetchReceptionStatuses({
    ...
    const {
      receptionStatuses,
      page
    } = await this.$receptionStatuses.pageReceptionStatuses(requestPage, size, sortBy, direction, filter);
