...
export const SET_CLIENT_TYPES = 'setClientTypes';
export const SET_CLIENTS = 'setClients';
export const SET_CLIENT = 'setClient';
export const SET_SALE_ORDERS = 'setSaleOrders';
export const SET_SALE_STATUSES = 'setSaleStatuses';
export const SET_SALE_ORDER = 'setSaleOrder';
